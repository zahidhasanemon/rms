            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('unit') }}">Units</a></li>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('unit.update', $unit->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="code" id="code" value="{{ $unit->code }}" placeholder="Code"> 
                        ...
                        <div class="form-group">
                            ...
                            <select name="assigned_to" class="form-control{{ $errors->has('assigned_to') ? ' is-invalid' : '' }}" id="assigned_to">
                                ...
                                <option value="1" @if($unit->assigned_to == 1) selected="selected" @endif>User</option>
                                <option value="2" @if($unit->assigned_to == 2) selected="selected" @endif>Lab</option>
                                <option value="3" @if($unit->assigned_to == 3) selected="selected" @endif>Free</option>
                            </select>
                        ...
                        <div id="assignment_info">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_id" class="form-control" id="user_id" required="required"> 
                                    <option value="">Select</option> 
                                    @forelse($users as $user) 
                                    <option value="{{ $user->id }}" @if( $unit->user_id == $user->id ) selected @endif> {{ $user->name }} </option> 
                                    @empty 
                            ...
                            <div class="form-group">
                                ...
                                <select name="lab_id" class="form-control" id="lab_id" required="required"> 
                                    <option value="">Select</option> 
                                    @forelse($labs as $lab) 
                                    <option value="{{ $lab->id }}" @if( $unit->lab_id == $lab->id ) selected @endif> {{ $lab->name }} </option> 
                                    @empty 
                        ...
                        <div class="form-group">
                            ...
                            <select name="component_id[]" class="form-control component_id" id="component_id" required="required" multiple="multiple">
                                <option value="">Select</option>
                                
                                @forelse($components as $component)
                                
                                <option value="{{ $component->id }}" @foreach($oldcomponents as $oldcomponent) @if($oldcomponent->id == $component->id) selected="selected" @endif @endforeach>
                                    {{ $component->code }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="details" class="form-control {{ $errors->has('details') ? ' is-invalid' : '' }}" id="details" cols="30" rows="5" placeholder="Remarks">{{ $unit->details }}</textarea>
